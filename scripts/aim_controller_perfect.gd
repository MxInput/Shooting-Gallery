...
@export var bullet_outline7 : TextureRect;
@export var bullet_outline8 : TextureRect;
@export var bullet_outline9 : TextureRect;
@export var bullet_outline10 : TextureRect;
@export var bullet_outline11 : TextureRect;
@export var bullet_outline12 : TextureRect;
...
var bullet_12_reload_time := 0.02;
var bullet_11_reload_time := 0.04;
var bullet_10_reload_time := 0.06;
var bullet_9_reload_time := 0.08;
var bullet_8_reload_time := 0.10;
var bullet_7_reload_time := 0.12;
var bullet_6_reload_time := 0.14;
var bullet_5_reload_time := 0.16;
var bullet_4_reload_time := 0.18;
var bullet_3_reload_time := 0.20;
var bullet_2_reload_time := 0.22;
var bullet_1_reload_time := 0.24;
...
func _process(_delta: float) -> void:
	if (!pause_manager.is_paused()):
			...
			if (Input.is_action_pressed("left_click")):
				if (target_spawner.waves_remaining <= target_spawner.max_waves):
					if (delay_timer.is_stopped()):
						...
						if (ammo > 0):
							if (ammo == 12):
								bullet_outline12.get_child(0).visible = false;
							elif (ammo == 11):
								bullet_outline11.get_child(0).visible = false;
							elif (ammo == 10):
								bullet_outline10.get_child(0).visible = false;
							elif (ammo == 9):
								bullet_outline9.get_child(0).visible = false;
							elif (ammo == 8):
								bullet_outline8.get_child(0).visible = false;
							elif (ammo == 7):
								bullet_outline7.get_child(0).visible = false;
							elif (ammo == 6):
		...
		if (!reload_timer.is_stopped()):
			...
			if (time_left <= bullet_12_reload_time):
				if (!bullet_outline12.visible):
					bullet_outline12.get_child(0).texture = silver_bullet;
				bullet_outline12.get_child(0).visible = true;
			if (time_left <= bullet_11_reload_time):
				if (!bullet_outline11.visible):
					bullet_outline11.get_child(0).texture = silver_bullet;
				bullet_outline11.get_child(0).visible = true;
			if (time_left <= bullet_10_reload_time):
				if (!bullet_outline10.visible):
					bullet_outline10.get_child(0).texture = silver_bullet;
				bullet_outline10.get_child(0).visible = true;
			if (time_left <= bullet_9_reload_time):
				if (!bullet_outline9.visible):
					bullet_outline9.get_child(0).texture = silver_bullet;
				bullet_outline9.get_child(0).visible = true;
			if (time_left <= bullet_8_reload_time):
				if (!bullet_outline8.visible):
					bullet_outline8.get_child(0).texture = silver_bullet;
				bullet_outline8.get_child(0).visible = true;
			if (time_left <= bullet_7_reload_time):
				if (!bullet_outline7.visible):
					bullet_outline7.get_child(0).texture = silver_bullet;
				bullet_outline7.get_child(0).visible = true;
			if (time_left <= bullet_6_reload_time):
				if (!bullet_outline6.visible):
...
func _on_reload_timer_timeout() -> void:
	...
	bullet_outline7.get_child(0).texture = gold_bullet;
	bullet_outline8.get_child(0).texture = gold_bullet;
	bullet_outline9.get_child(0).texture = gold_bullet;
	bullet_outline10.get_child(0).texture = gold_bullet;
	bullet_outline11.get_child(0).texture = gold_bullet;
	bullet_outline12.get_child(0).texture = gold_bullet;
