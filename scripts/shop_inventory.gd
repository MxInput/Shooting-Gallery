...
func _init(_inventory := []) -> void:
	inventory = [
		...
		ShopItem.new("005", "Get 100+ in Timed.", ImageTexture.create_from_image(Image.load_from_file("res://images/crosshairs/crosshair004.png"))),
		ShopItem.new("006", "Get a perfect in Perfect.", ImageTexture.create_from_image(Image.load_from_file("res://images/crosshairs/crosshair022.png"))),
		ShopItem.new("007", "Run out of ammo 6+ times in Burst.", ImageTexture.create_from_image(Image.load_from_file("res://images/crosshairs/crosshair192.png"))),
		ShopItem.new("008", "Earn your first crosshair.", ImageTexture.create_from_image(Image.load_from_file("res://images/crosshairs/crosshair190.png")))
	];
