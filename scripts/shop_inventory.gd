...
func _init(_inventory := []) -> void:
	inventory = [
		...
		ShopItem.new("003", "Hit a combination of 300 targets and ducks.", ImageTexture.create_from_image(load("res://images/crosshair_img/crosshair007.png"))),
		ShopItem.new("004", "Last 1+ minutes in Hunting.", ImageTexture.create_from_image(load("res://images/crosshair_img/crosshair025.png"))),
		ShopItem.new("005", "Get 275+ in Timed.", ImageTexture.create_from_image(load("res://images/crosshair_img/crosshair004.png"))),
